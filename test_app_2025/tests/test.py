...
sys.path.append(str(Path(__file__).resolve().parent.parent)) # This instead the config.py file inside the app. because with this way we take dynamically our project path.  
